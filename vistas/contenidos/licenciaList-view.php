...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Lista de Licencias Emitidas</h1>
      </div><!-- /.col -->
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="<?php echo SERVERURL;?>home/">Home</a></li>
        <li class="breadcrumb-item active">Lista Licencias</li>
      </ol>
    </div><!-- /.col -->
  </div><!-- /.row -->
  </div><!-- /.container-fluid -->
    ...
    <!-- /.Cabezera de contenido central -->
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Tabla con la lista de licencias emitidas en el sistema</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td>917452076</td>
                <td>jose luis alvarez escobar</td>
                <td>
