		...
		<nav class="full-box nav-lateral-menu">
			<ul>
				...
				<li>
					...
					<ul>
						<li>
							<a href="<?php echo SERVERURL;?>servicioNew/"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar item</a>
						</li>
						<li>
							<a href="<?php echo SERVERURL;?>servicioList/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de items</a>
						</li>
						<li>
							<a href="<?php echo SERVERURL;?>servicioSearch/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar item</a>
						</li>
					</ul>
				</li>

				<li>
					<a href="#" class="nav-btn-submenu"><i class="fas fa-store fa-fw"></i> &nbsp; Negocios <i class="fas fa-chevron-down"></i></a>
					<ul>
						<li>
